...
public class PL0Parser extends Parser {
	...
	public static final int
		...
		RULE_variableDeclDefinition = 14, RULE_constExpr = 15, RULE_procDecl = 16, 
		RULE_returnType = 17, RULE_procFormalCallChoice = 18, RULE_formalDeclInnerRepeat = 19, 
		RULE_formalDecl = 20, RULE_type = 21, RULE_arrType = 22, RULE_mainStmtList = 23, 
		RULE_stmtListStmtInner = 24, RULE_blockStmtList = 25, RULE_blockStmtListInner = 26, 
		RULE_stmt = 27, RULE_callStmt = 28, RULE_parameters = 29, RULE_parametersInnerRepeat = 30, 
		RULE_assignStmt = 31, RULE_lvalue = 32, RULE_arrayIntSelection = 33, RULE_returnStmt = 34, 
		RULE_returnStatementChoice = 35, RULE_outStmt = 36, RULE_outStmtInner = 37, 
		RULE_ifStmt = 38, RULE_ifStmtInner = 39, RULE_whileStmt = 40, RULE_forStmt = 41, 
		RULE_condition = 42, RULE_conditionBooleans = 43, RULE_conditionStatement = 44, 
		RULE_conditionalOperations = 45, RULE_expr = 46, RULE_expressionInner = 47, 
		RULE_term = 48, RULE_termMultDivFactor = 49, RULE_factor = 50;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"parameters", "parametersInnerRepeat", "assignStmt", "lvalue", "arrayIntSelection", 
	...
	public final VariableDeclDefinitionContext variableDeclDefinition() throws RecognitionException {
		...
		enterRule(_localctx, 28, RULE_variableDeclDefinition);
		try {
			setState(169);
			_errHandler.sync(this);
	...
	public final ConstExprContext constExpr() throws RecognitionException {
		...
		enterRule(_localctx, 30, RULE_constExpr);
		try {
			setState(173);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final ProcFormalCallChoiceContext procFormalCallChoice() throws RecognitionException {
		...
		enterRule(_localctx, 36, RULE_procFormalCallChoice);
		try {
			setState(194);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final FormalDeclInnerRepeatContext formalDeclInnerRepeat() throws RecognitionException {
		...
		enterRule(_localctx, 38, RULE_formalDeclInnerRepeat);
		try {
			setState(201);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final FormalDeclContext formalDecl() throws RecognitionException {
		...
		enterRule(_localctx, 40, RULE_formalDecl);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(203);
	...
	public final MainStmtListContext mainStmtList() throws RecognitionException {
		...
		enterRule(_localctx, 46, RULE_mainStmtList);
		try {
			setState(227);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final StmtListStmtInnerContext stmtListStmtInner() throws RecognitionException {
		...
		enterRule(_localctx, 48, RULE_stmtListStmtInner);
		try {
			setState(231);
			_errHandler.sync(this);
	...
	public final BlockStmtListContext blockStmtList() throws RecognitionException {
		...
		enterRule(_localctx, 50, RULE_blockStmtList);
		try {
			setState(238);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final BlockStmtListInnerContext blockStmtListInner() throws RecognitionException {
		...
		enterRule(_localctx, 52, RULE_blockStmtListInner);
		try {
			setState(242);
			_errHandler.sync(this);
	...
	public final CallStmtContext callStmt() throws RecognitionException {
		...
		enterRule(_localctx, 56, RULE_callStmt);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(253);
	...
	public final ParametersInnerRepeatContext parametersInnerRepeat() throws RecognitionException {
		...
		enterRule(_localctx, 60, RULE_parametersInnerRepeat);
		try {
			setState(269);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final ArrayIntSelectionContext arrayIntSelection() throws RecognitionException {
		...
		enterRule(_localctx, 66, RULE_arrayIntSelection);
		try {
			setState(283);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final ReturnStatementChoiceContext returnStatementChoice() throws RecognitionException {
		...
		enterRule(_localctx, 70, RULE_returnStatementChoice);
		try {
			setState(290);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final OutStmtContext outStmt() throws RecognitionException {
		...
		enterRule(_localctx, 72, RULE_outStmt);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(292);
	...
	public final OutStmtInnerContext outStmtInner() throws RecognitionException {
		...
		enterRule(_localctx, 74, RULE_outStmtInner);
		try {
			setState(298);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final IfStmtInnerContext ifStmtInner() throws RecognitionException {
		...
		enterRule(_localctx, 78, RULE_ifStmtInner);
		try {
			setState(313);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final ConditionBooleansContext conditionBooleans() throws RecognitionException {
		...
		enterRule(_localctx, 86, RULE_conditionBooleans);
		try {
			setState(341);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final ConditionStatementContext conditionStatement() throws RecognitionException {
		...
		enterRule(_localctx, 88, RULE_conditionStatement);
		try {
			setState(349);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final ConditionalOperationsContext conditionalOperations() throws RecognitionException {
		...
		enterRule(_localctx, 90, RULE_conditionalOperations);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final ExpressionInnerContext expressionInner() throws RecognitionException {
		...
		enterRule(_localctx, 94, RULE_expressionInner);
		try {
			setState(365);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final TermMultDivFactorContext termMultDivFactor() throws RecognitionException {
		...
		enterRule(_localctx, 98, RULE_termMultDivFactor);
		try {
			setState(379);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
